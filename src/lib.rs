...
#[no_mangle] pub extern "C" fn zos_plugin_name() -> *mut c_char { to_c("bert") }
#[no_mangle] pub extern "C" fn zos_plugin_version() -> *mut c_char { to_c("0.2.0") }
#[no_mangle] pub extern "C" fn zos_plugin_commands() -> *mut c_char { to_c("embed,sentiment,similarity") }
...
#[no_mangle] pub extern "C" fn zos_plugin_execute(cmd: *const c_char, arg: *const c_char) -> *mut c_char {
    ...
    let result = json!({"plugin": "bert", "command": cmd, "arg": arg, "status": "ok"});
    let shard = DA51Shard::from_result("bert", cmd, &result);
